...
- Forked from: https://github.com/falbatech/zmk-config-corne-
...
- How to reset each half => https://zmk.dev/docs/troubleshooting/connection-issues#reset-split-keyboard-procedure
